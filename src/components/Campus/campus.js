                ...
                <div class="uk-width-2-3@m">
                    <div class="uk-card uk-card-default uk-card-body">
                       <p className='text-black'>
                            Why should we opt Rathinam? Though the answer varies for each student, there are some things that we all agree upon. There is diversity in people here and everyone are open-minded, passionate towards their work and friendly.
                       </p>
                       <p className='text-black'>
