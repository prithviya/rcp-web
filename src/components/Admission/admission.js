  ...
  return (
    <div>
        ...
        <div className='uk-section uk-section-muted'>
            ...
            <div className=''>
                    <h1 className='custom_heading'>
                        Bachelor of <span>Physiotherapy (B.P.T)</span>
                    </h1>
                    <div class="uk-child-width-1-2@m uk-flex-middle uk-grid-small uk-grid-match" data-uk-grid>
                        ...
                        <div>
                            <div class="uk-card">
                               <img src='https://img.freepik.com/free-photo/personal-trainer-gym-correcting-student-s-stretching-coronavirus-pandemic-new-normal-with-protective-face-mask_242111-18944.jpg?w=740&t=st=1662966307~exp=1662966907~hmac=8bc29099a7902f01325c64a5c450918b53d3ef75a88c033a1362d3783016d554' alt='admission'/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className='uk-section'>
            <div className='uk-container'>
            <div className='uk-card-default uk-card-body uk-card-hover'>
                    <h1 className='custom_heading'>
        ...
        <div className='uk-section uk-section-muted'>
            ...
            <div className=''>
                    ...
                    <div class="uk-child-width-1-2@m uk-flex-middle uk-grid-small uk-grid-match" data-uk-grid>
                        <div>
                            <div class="uk-card">
                               <img src='https://img.freepik.com/free-photo/young-adults-coworkers-analyzing-document_329181-19758.jpg?w=740&t=st=1662968664~exp=1662969264~hmac=f420158b64d6c230c03ee7dd5e7b6049034d7a8fc9366d18719641eb00b193cf' alt='admission'/>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card uk-card-body">
