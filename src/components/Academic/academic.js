                                ...
                                <div>
                                    <div className="uk-card uk-padding-small uk-padding-remove-bottom">
                                        <p className='uk-text-justify'>
                                            The Rathinam College of Physiotherapy(RCP) is one among the pioneers in the field of Physiotherapy education. It was started as the new blossom of Rathinam Group of Institutions with the focus on turnout skilled and dedicated Physiotherapy professionals. 
                                        </p>
                                        <p>
                                            Rathinam College of Physiotherapy was established in the year 2021 and it offers an intense and high-quality Bachelor of Physiotherapy (BPT) course that combines creative learning and experimental learning. The College of Physiotherapy is committed to striving to be one of the best Physiotherapy colleges in Coimbatore with educational excellence.
                                        </p>
                                    </div>
                                </div>
                                <div>
